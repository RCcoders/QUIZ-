...
const jsonLd = {
  ...
  screenshot: 'https://quizly.app/screenshot.png',
  author: { '@type': 'Organization', name: 'Quizly' },
  offers: {
    '@type': 'Offer',
    price: '0',
    priceCurrency: 'USD',
  ...
  mainEntity: [
    {
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Paste any text, URL, or topic into Quizly and the AI generates up to 20 questions in seconds.',
      },
    },
    {
      '@type': 'Question',
      name: 'Is Quizly free to use?',
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Yes, Quizly has a free tier that supports up to 5 quizzes and 30 students per session.',
      },
    },
    {
      '@type': 'Question',
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Students visit quizly.app/join and enter the 6-character game code provided by their teacher.',
      },
    },
  ],
};
...
const jsonLdBreadcrumb = {
  ...
  '@type': 'BreadcrumbList',
  itemListElement: [
    { '@type': 'ListItem', position: 1, name: 'Home', item: 'https://quizly.app/' },
  ],
};
  ...
  return (
    <LazyMotion features={domAnimation}>
      <div style={{ minHeight: '100vh', background: '#F5F5F5', fontFamily: "'Inter', sans-serif" }}>
        <Helmet>
          <title>Quizly — Create AI Quizzes Instantly</title>
          ...
          <section style={{ padding: '80px 24px', background: '#F5F5F5' }}>
            <div style={{ maxWidth: 1200, margin: '0 auto' }}>
              <div style={{ textAlign: 'center', marginBottom: 56 }}>
                ...
                <p style={{ fontSize: 16, color: '#4B5563' }}>
                  Join thousands of teachers already using Quizly.
                </p>
              </div>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '2fr 1fr 1fr 1fr', gap: 48, marginBottom: 48 }}>
              ...
              <div>
                <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 16 }}>
                  ...
                  <span style={{ fontWeight: 700, fontSize: 20, color: '#FFFFFF' }}>Quizly</span>
                </div>
