...
export function SignupPage() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            if (signUpError) throw new Error(typeof signUpError === 'string' ? signUpError : 'Signup failed');
    ...
    const handleGoogleSignIn = () => {
        setError('Google sign-up is currently unavailable. Please use email/password.');
    };

    return (
        <>
            <Helmet>
                <title>Sign Up Free — Quizly</title>
                ...
                <div style={{
                    ...
                    <div style={{ position: 'relative', zIndex: 1, textAlign: 'center', padding: '0 48px' }}>
                        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '10px', marginBottom: '32px' }}>
                            ...
                            <span style={{ color: 'white', fontWeight: 700, fontSize: '1.4rem' }}>Quizly</span>
                        </div>
                        <h1 style={{
                        ...
                        <p style={{ color: 'rgba(255,255,255,0.75)', fontSize: '1rem', lineHeight: 1.6 }}>
                            Join thousands of students and teachers using Quizly to make learning engaging and effective.
                        </p>
                ...
                <div style={{
                    ...
                    <div style={{ width: '100%', maxWidth: '400px' }}>
                        ...
                        <p style={{ color: '#6B7280', marginBottom: '28px', fontSize: '0.95rem' }}>
                            Sign up to get started with Quizly
                        </p>
