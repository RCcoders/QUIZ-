...
export default function TermsPage() {
  return (
    <>
      <Helmet>
        <title>Terms of Service — QuizMaster</title>
        <meta name="description" content="Read the QuizMaster terms of service and acceptable use policy." />
      </Helmet>
      ...
      <div style={{ minHeight: '100vh', background: '#0f172a', color: '#e2e8f0', fontFamily: 'system-ui, sans-serif' }}>
        ...
        <main style={{ maxWidth: '800px', margin: '0 auto', padding: '3rem 2rem' }}>
          ...
          <section style={{ marginBottom: '2rem' }}>
            ...
            <p>By accessing or using QuizMaster, you agree to be bound by these Terms of Service. If you do not agree, please do not use the platform.</p>
          </section>

          <section style={{ marginBottom: '2rem' }}>
            <h2 style={{ fontSize: '1.25rem', fontWeight: 600, marginBottom: '0.75rem', color: '#c7d2fe' }}>Use of Service</h2>
            <p>QuizMaster provides an AI-powered quiz creation and hosting platform for educational use. You may use the service for lawful educational purposes in accordance with these terms.</p>
          </section>
          ...
          <section style={{ marginBottom: '2rem' }}>
            ...
            <p>You agree not to use QuizMaster to upload harmful, illegal, or offensive content; to attempt to gain unauthorized access to the platform; or to interfere with other users' experience.</p>
          </section>

          <section style={{ marginBottom: '2rem' }}>
            <h2 style={{ fontSize: '1.25rem', fontWeight: 600, marginBottom: '0.75rem', color: '#c7d2fe' }}>Intellectual Property</h2>
            <p>QuizMaster and its original content, features, and functionality are owned by QuizMaster and protected by applicable intellectual property laws. Quizzes you create remain your property.</p>
          </section>

          <section style={{ marginBottom: '2rem' }}>
            <h2 style={{ fontSize: '1.25rem', fontWeight: 600, marginBottom: '0.75rem', color: '#c7d2fe' }}>Disclaimer</h2>
            <p>QuizMaster is provided "as is" without warranties of any kind. We do not guarantee uninterrupted or error-free service and disclaim all implied warranties to the fullest extent permitted by law.</p>
          </section>

          <section style={{ marginBottom: '2rem' }}>
            <h2 style={{ fontSize: '1.25rem', fontWeight: 600, marginBottom: '0.75rem', color: '#c7d2fe' }}>Limitation of Liability</h2>
            <p>To the maximum extent permitted by law, QuizMaster shall not be liable for any indirect, incidental, special, or consequential damages arising from your use of the platform.</p>
          </section>
          ...
          <section style={{ marginBottom: '2rem' }}>
            ...
            <p>For questions about these terms, email us at <strong>legal@quizmaster.app</strong>.</p>
          </section>
        </main>
